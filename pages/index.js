...
const [ref3, inView3] = useInView({
  ...
  return (
    <div>
      ...
      <div className="h-screen overflow-scroll snap snap-y snap-mandatory overflow-x-hidden xl:overflow-auto xl:snap-none xl:flex xl:w-screen xl:h-screen xl:justify-center xl:items-center xl:px-10">
        <Burger />
